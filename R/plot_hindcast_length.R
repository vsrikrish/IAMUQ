...
th <- theme_bw(base_size=8) + theme(panel.grid.major=element_blank(), panel.grid.minor=element_blank())
theme_set(th)
...
pdf('figures/hindcast_length.pdf', width=3.5, height=7)
grid.draw(g)
dev.off()


png('figures/hindcast_length.png', width=3.5, height=7.5, units='in', res=600)
grid.draw(g)
dev.off()
